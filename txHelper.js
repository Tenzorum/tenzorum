...
var addActionNoReward = async function(account) {
    let ethAmountInWei = 0;
    let data = await prepareAddActionData(account);
    let payload = await preparePayload(personalWalletAddress, publicAddress, personalWalletAddress, ethAmountInWei, data, rewardTypeEther, noReward);
    console.log(payload);
}
...
//
let newAccount = "0xF938BfDC53F72cB7a4B1946969bA0ccE05C902c6";
addMasterNoReward(newAccount);
//
// addActionNoReward(newAccount);
